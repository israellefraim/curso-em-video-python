...
# Criar uma array de valores para representar as células
valor_cedula = [50, 20, 10, 1]

# Perguntar ao usuário o valor a ser sacado e atribui esse valor a variável
valor_sacado = int(input("Insira um valor a ser sacado: R$"))
total_valor = valor_sacado

# Criar laço de repetição para definir quantas cédulas serão dadas
i = 0
